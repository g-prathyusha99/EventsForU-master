...
def eventcategories(request):
     return render(request,"eventcategories.html")
def careerevents(request):
     return render(request,"careerevents.html")
def sportsevents(request):
     return render(request,"sports.html")
def tripsevents(request):
...
def aboutorg(request):
     return render(request,"aboutOrg.html")
